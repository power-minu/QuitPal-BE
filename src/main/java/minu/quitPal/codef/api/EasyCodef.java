...
public class EasyCodef {
    ...
    private final EasyCodefConnector easyCodefConnector;
     ...
     */
    public String requestProduct(String productUrl, EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public String requestCertification(String productUrl, EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws IOException, InterruptedException {
        boolean validationFlag = true;
     ...
     * @throws InterruptedException
     */
    public String createAccount(EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public String addAccount(EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public String updateAccount(EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public String deleteAccount(EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public String getAccountList(EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public String getConnectedIdList(EasyCodefServiceType serviceType) throws IOException, InterruptedException {
    ...
    public String requestToken(EasyCodefServiceType serviceType) throws JsonParseException, JsonMappingException, IOException {
        ...
        Optional<AccessToken> accessToken = accessTokenRepository.findAccessTokenByClientId(clientId); // 보유 중인 토큰이 있는 경우 반환
        if(accessToken.isPresent()) {
            String tokenValue = accessToken.get().getToken();
            HashMap<String, Object> tokenMap = EasyCodefUtil.getTokenMap(tokenValue);
            if(EasyCodefUtil.checkValidity((int)(tokenMap.get("exp")))) {	// 토큰의 유효 기간 확인
                return tokenValue;	// 정상 토큰인 경우 반환
            }
        }
